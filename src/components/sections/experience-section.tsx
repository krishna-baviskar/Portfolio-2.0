          ...
          <div className="space-y-8">
            {experiences.map((exp, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-gradient-to-br from-slate-900/50 to-slate-800/50 p-8 rounded-2xl backdrop-blur-lg border border-slate-700/30 hover:border-purple-500/50 transform hover:scale-105 transition-all duration-300 hover:shadow-2xl hover:shadow-purple-500/20"
                >
                  <div className="flex flex-col md:flex-row gap-6">
                    <div className={`w-20 h-20 bg-gradient-to-br ${exp.color} rounded-2xl flex items-center justify-center flex-shrink-0 transform hover:rotate-12 transition-transform duration-300`}>
                      <Icon size={40} />
                    </div>
